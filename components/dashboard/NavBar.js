  ...
  return (
      ...
      <div className="flex-col w-[72rem] h-[20%] mt-[1rem]">
        ...
        <div className="flex text-white w-full h-[40px] pl-[2.5rem]">
          ...
          <div className="font-bold text-[13px]">/ Dashboard
        </div>
          {/* Bars */}
          ...
          <div className="flex gap-[30px] flex-row-reverse w-[84%] h-auto text-white text-[13px]">
        ...
        <div className="flex flex-col w-full h-[110px] pl-[2.5rem]">
          <div className="flex text-white  gap-5">
            <div className='font-[700] text-[1.5rem]'>Willkommen Kristian Kovac</div>
          </div>
        </div>
      </div>
  );
